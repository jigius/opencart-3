...
echo $url->link("product/product", ['product_id' => 123, 'path' => 78]) === "http://example.com/index.php?route=product/product&amp;product_id=123&path=78"? ".": "E";
...
echo $url->link("product/product", ['product_id' => 123, 'path' => 78]) === "http://example.com/parrot?path=78"? ".": "E";
 ...
 */
$registry->set('db', new FakedDb(['product' => "parrot"]));
echo $url->link("product/product", ['path' => 78, 'product_id' => 123]) === "http://example.com/parrot?path=78"? ".": "E";
...
echo $url->link("product/product", ['product_id' => 123, 'path' => 78]) === "http://example.com/parrot/tree"? ".": "E";
...
$registry->set('db', new FakedDb(['product' => "parrot", 'category' => "tree"]));
echo $url->link("product/product", ['path' => 78, 'product_id' => 123]) === "http://example.com/tree/parrot"? ".": "E";
...
echo $url->link("product/product", ['path' => 78, 'product_id' => 123]) === "http://example.com/tree?product_id=123"? ".": "E";
 ...
 */
$registry->set('db', new FakedDb(['category' => "tree"]));
echo $url->link("product/product", ['product_id' => 123, 'path' => 78]) === "http://example.com/tree?product_id=123"? ".": "E";
